...
- objectWrapperFactory 与objectFactory相似
...
- reflectorFactory 与objectFactory相似
...
- <cache>节点，mybatis有一级二级缓存，二级缓存默认是不开启的
...
- CacheBuilder 采用建造者模式 构造Cache对象
